    ...
    return (
        <div className="-m-8 h-[calc(100vh)] flex flex-col">
            <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between flex-shrink-0">
                ...
                <Link to="/admin/blog/new" className="bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors flex items-center gap-2">
                ...
                <div className="w-full lg:w-1/2 h-1/2 lg:h-full overflow-y-auto bg-gray-50/50 border-b lg:border-b-0 lg:border-r border-gray-100">
                    {loading ? (
                        ...
                        <div className="p-12 text-center">
                            ...
                            <Link to="/admin/blog/new" className="inline-flex items-center gap-1 text-blue-600 text-sm font-medium mt-3 hover:underline"><span className="material-symbols-outlined text-sm">add</span> Tulis artikel pertama</Link>
                        </div>
                    ) : (
                                ...
                                <div key={post.id} className="bg-white rounded-xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            <span className="bg-blue-50 text-blue-600 text-[10px] px-2 py-0.5 rounded-full font-medium">{post.category}</span>
                                    ...
                                    <div className="flex gap-1 flex-shrink-0">
                                        <Link to={`/admin/blog/${post.id}`} className="text-gray-400 hover:text-blue-600 p-1.5 rounded-lg hover:bg-blue-50 transition-colors"><span className="material-symbols-outlined text-lg">edit</span></Link>
